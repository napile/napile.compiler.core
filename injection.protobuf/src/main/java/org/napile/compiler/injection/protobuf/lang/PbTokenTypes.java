...
public interface PbTokenTypes
{
	...
	IElementType GROUP = new PbElementType("GROUP");
	TokenSet GROUP_SET = TokenSet.create(GROUP); //hack for lookAhead
	...
	TokenSet BUILT_IN_TYPES = TokenSet.create(DOUBLE, FLOAT, INT32, INT64, UINT32, UINT64, SINT32, SINT64, FIXED32, FIXED64, SFIXED32, SFIXED64, BOOL, STRING, BYTES);  //keywords

	TokenSet OTHER_KEYWORDS = TokenSet.create(RPC, RETURNS, GROUP, EXTENSIONS, TO, MAX);//keywords


	TokenSet KEYWORDS = TokenSet.orSet(BUILT_IN_TYPES,										/*FIELD_OPTIONS,*/
			FIELD_LABELS, BOOL_VALUES, DECLARATIONS, OTHER_KEYWORDS);
