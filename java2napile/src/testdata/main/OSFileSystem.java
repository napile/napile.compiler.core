...
class OSFileSystem implements IFileSystem {
	...
	private final void validateLockArgs(int type, long start, long length) {
		if ((type != org.apache.harmony.luni.platform.IFileSystem.SHARED_LOCK_TYPE)
				&& (type != org.apache.harmony.luni.platform.IFileSystem.EXCLUSIVE_LOCK_TYPE)) {
	...
	public void unlock(long fileDescriptor, long start, long length)
			throws IOException {
		// Validate arguments
		validateLockArgs(org.apache.harmony.luni.platform.IFileSystem.SHARED_LOCK_TYPE, start, length);
