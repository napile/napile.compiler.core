...
public class StandaloneJavaToKotlinConverterTest extends TestCase
{
	...
	protected void runTest() throws Throwable
	{
		...
		else if(parentFileName.equals("comp"))
			actual = fileToFileWithCompatibilityImport(javaCode);
	...
	{
		String result = fileToKotlin(converter, "final class C {" + text + "}").replaceAll("class C\\(\\) \\{", "");
