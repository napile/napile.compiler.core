...
public class NewClassExpression extends Expression
{
	...
	public String toKotlin()
	{
		...
		return myAnonymousClass != null ? "object" + SPACE + ":" + SPACE + qualifier + myName.toKotlin() + "(" + appliedArguments + ")" + myAnonymousClass.toKotlin() : qualifier + myName.toKotlin() + "(" + appliedArguments + ")";
	}
}
