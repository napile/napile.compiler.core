...
public class Method extends Member
{
	...
	public Method(Identifier name, Set<String> modifiers, Type type, List<Element> typeParameters, Element params, Block block)
	{
		myName = name;
	...
	@NotNull
	protected String typeParametersToKotlin()
	{
