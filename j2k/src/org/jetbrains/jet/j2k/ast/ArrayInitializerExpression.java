...
public class ArrayInitializerExpression extends Expression
{
	...
	{
		Set<String> doubleOrFloatTypes = new HashSet<String>(Arrays.asList("double", "float", "java.lang.double", "java.lang.float"));
	...
	private static String getConversion(@NotNull final String afterReplace)
	{
		if(afterReplace.contains("double"))
			return DOT + OperatorConventions.DOUBLE + "()";
		if(afterReplace.contains("float"))
			return DOT + OperatorConventions.FLOAT + "()";
		return "";
	}
