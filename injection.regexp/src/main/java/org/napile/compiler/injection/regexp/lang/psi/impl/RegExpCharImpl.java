...
import org.napile.compiler.injection.regexp.lang.psi.RegExpChar;
...
{
	private static final TokenSet OCT_CHARS = TokenSet.create(RegExpTokens.OCT_CHAR, RegExpTokens.BAD_OCT_VALUE);
	private static final TokenSet HEX_CHARS = TokenSet.create(RegExpTokens.HEX_CHAR, RegExpTokens.BAD_HEX_VALUE);
	private static final TokenSet UNICODE_CHARS = TokenSet.create(RegExpTokens.HEX_CHAR, StringEscapesTokenTypes.INVALID_UNICODE_ESCAPE_TOKEN);
