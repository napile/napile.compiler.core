 ...
 */
package org.napile.compiler.lang.resolve.constants.stringLexer;
...
public class StringLiteralLexer extends LexerBase
{
	 ...
	 * @param allowOctal
	 */
	public StringLiteralLexer(char quoteChar, final IElementType originalLiteralToken, boolean canEscapeEolOrFramingSpaces, String additionalValidEscapes, boolean allowOctal, boolean allowHex)
	{
