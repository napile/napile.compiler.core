...
{
	protected VariableDeclarationInstruction(@NotNull NapileCallParameterAsVariable element)
	{
		super(element);
	}
	...
	public NapileDeclaration getVariableDeclarationElement()
	{
		return (NapileDeclaration) element;
	}
