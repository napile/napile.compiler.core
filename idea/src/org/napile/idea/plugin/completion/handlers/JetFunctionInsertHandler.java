...
/**
 * Performs number of code modification after insertion idea function:
 * - Insert ()
...
public class JetFunctionInsertHandler implements InsertHandler<LookupElement>
{
	...
	{
		return PsiTreeUtil.getParentOfType(element, NapileImportDirective.class) == null;
	}
