...
public class JetJavaClassInsertHandler implements InsertHandler<JavaPsiClassReferenceElement>
{
	...
	{
		if(context.getFile() instanceof NapileFile)
		{
			ImportInsertHelper.addImportDirectiveOrChangeToFqName(new FqName(item.getQualifiedName()), (NapileFile) context.getFile(), context.getStartOffset(), item.getObject());
		}
