...
public final class AnalyzeSingleFileUtil
{
	...
	@NotNull
	public static AnalyzeExhaust analyzeSingleFileWithCache(@NotNull NapileFile file)
	{
		return AnalyzerFacadeWithCache.analyzeFileWithCache(file, AnalyzerFacadeWithCache.SINGLE_DECLARATION_PROVIDER);
	}

	@NotNull
	public static BindingContext getContextForSingleFile(@NotNull NapileFile file)
	{
