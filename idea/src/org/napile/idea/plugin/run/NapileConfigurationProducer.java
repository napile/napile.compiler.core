...
public class NapileConfigurationProducer extends RuntimeConfigurationProducer implements Cloneable
{
	...
	protected RunnerAndConfigurationSettings createConfigurationByElement(Location location, ConfigurationContext context)
	{
		...
		{
			analyzeExhaust = WholeProjectAnalyzerFacade.analyzeProjectWithCacheOnAFile((NapileFile) element);
		...
		else if(element instanceof NapileClass)
		{
			...
			analyzeExhaust = WholeProjectAnalyzerFacade.analyzeProjectWithCacheOnAFile(((NapileClass) element).getContainingFile());
		}
		else
			return null;
