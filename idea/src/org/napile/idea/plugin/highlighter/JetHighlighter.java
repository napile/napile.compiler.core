...
public class JetHighlighter extends SyntaxHighlighterBase
{
	...
	static
	{
		...
		fillMap(keys, JetTokens.OPERATIONS.minus(TokenSet.create(JetTokens.IDENTIFIER, JetTokens.LABEL_IDENTIFIER)).minus(JetTokens.KEYWORDS), JetHighlightingColors.OPERATOR_SIGN);
