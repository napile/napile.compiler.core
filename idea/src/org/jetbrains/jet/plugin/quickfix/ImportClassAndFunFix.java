...
public class ImportClassAndFunFix extends JetHintAction<JetSimpleNameExpression> implements HighPriorityAction
{
	...
	private static Collection<FqName> getJetExtensionFunctions(@NotNull final String referenceName, @NotNull JetSimpleNameExpression expression, @NotNull Project project)
	{
		JetShortNamesCache namesCache = JetShortNamesCache.getInstance(project);
