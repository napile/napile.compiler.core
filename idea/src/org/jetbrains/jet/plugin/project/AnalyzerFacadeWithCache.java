...
import org.jetbrains.jet.lang.resolve.JetFilesProvider;
...
public final class AnalyzerFacadeWithCache
{
	...
	private static AnalyzeExhaust analyzeHeadersWithCacheOnFile(@NotNull final JetFile fileToCache, @NotNull final Function<JetFile, Collection<JetFile>> declarationProvider)
	{
