...
public class JetInplaceVariableIntroducer extends InplaceVariableIntroducer<JetExpression>
{
	...
	@Nullable
	private final JetType myExprType;
	private final boolean noTypeInference;
	private JCheckBox myVarCheckbox;
	private JCheckBox myExprTypeCheckbox;

	public JetInplaceVariableIntroducer(PsiNamedElement elementToRename, Editor editor, Project project, String title, JetExpression[] occurrences, @Nullable JetExpression expr, boolean replaceOccurrence, JetProperty property, boolean isVar, boolean doNotChangeVar, @Nullable JetType exprType, boolean noTypeInference)
	{
