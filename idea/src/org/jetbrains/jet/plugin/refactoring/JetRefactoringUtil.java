...
public class JetRefactoringUtil
{
	...
	private static void smartSelectExpression(@NotNull Editor editor, @NotNull PsiFile file, int offset, @NotNull final SelectExpressionCallback callback) throws IntroduceRefactoringException
	{
		...
		while(element != null && !(element instanceof JetBlockExpression && !(element.getParent() instanceof JetFunctionLiteral)) &&
				!(element instanceof JetNamedFunction) && !(element instanceof JetClassBody))
		{
	...
	public static String getExpressionShortText(@NotNull JetExpression expression)
	...
	@Nullable
	public static JetExpression findExpression(@NotNull Editor editor, @NotNull PsiFile file, int startOffset, int endOffset) throws IntroduceRefactoringException
	{
