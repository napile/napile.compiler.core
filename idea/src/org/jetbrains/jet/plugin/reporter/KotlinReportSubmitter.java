...
public class KotlinReportSubmitter extends ErrorReportSubmitter
{
	 ...
	 */
	private static boolean sendError(IdeaLoggingEvent event, String additionalInfo, final Component parentComponent, final Consumer<SubmittedReportInfo> callback)
	{
