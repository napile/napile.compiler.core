...
public class JetCompletionContributor extends CompletionContributor
{
		...
		extend(CompletionType.BASIC, PlatformPatterns.psiElement(), new CompletionProvider<CompletionParameters>()
		{
			...
			protected void addCompletions(@NotNull CompletionParameters parameters, ProcessingContext context, @NotNull CompletionResultSet result)
			{
				...
				if(jetReference != null)
				{
					...
					BindingContext jetContext = WholeProjectAnalyzerFacade.analyzeProjectWithCacheOnAFile((JetFile) position.getContainingFile()).getBindingContext();
	...
	private static void addJetExtensions(JetSimpleNameExpression expression, CompletionResultSet result, PsiElement position)
	{
		...
		BindingContext context = WholeProjectAnalyzerFacade.analyzeProjectWithCacheOnAFile((JetFile) position.getContainingFile()).getBindingContext();
	...
	private static void addJetTopLevelFunctions(JetSimpleNameExpression expression, @NotNull CompletionResultSet result, @NotNull PsiElement position, @NotNull CompletionSession session)
	{
