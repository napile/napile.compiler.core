...
public class JetExtensionReceiverTypeContributor extends CompletionContributor
{
	...
	private static final ElementPattern<? extends PsiElement> ACTIVATION_PATTERN = PlatformPatterns.psiElement().afterLeaf(JetTokens.METH_KEYWORD.toString(), JetTokens.VAL_KEYWORD.toString(), JetTokens.VAR_KEYWORD.toString());
