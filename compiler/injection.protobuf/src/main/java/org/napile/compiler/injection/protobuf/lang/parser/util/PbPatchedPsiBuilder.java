package org.napile.compiler.injection.protobuf.lang.parser.util;

import com.intellij.lang.PsiBuilder;
import com.intellij.psi.tree.IElementType;
import com.intellij.psi.tree.TokenSet;
import org.napile.compiler.injection.protobuf.PbBundle;
...
public class PbPatchedPsiBuilder
{
	...
	public boolean lookAhead(IElementType... elements)
	{
		...
		if(elements.length == 1)
			return elements[0].equals(myBuilder.getTokenType());
		PsiBuilder.Marker marker = myBuilder.mark();
		int i = 0;
	...
	public boolean lookAhead(TokenSet... sets)
	{
		if(sets.length == 0)
			return false;
		if(sets.length == 1)
			return sets[0].contains(myBuilder.getTokenType());
		PsiBuilder.Marker marker = myBuilder.mark();
		int i = 0;
