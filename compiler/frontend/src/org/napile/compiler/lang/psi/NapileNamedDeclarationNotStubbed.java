...
@Deprecated
abstract class NapileNamedDeclarationNotStubbed extends NapileDeclarationImpl implements NapileNamedDeclaration
{
	public NapileNamedDeclarationNotStubbed(@NotNull ASTNode node)
	{
		super(node);
	}
