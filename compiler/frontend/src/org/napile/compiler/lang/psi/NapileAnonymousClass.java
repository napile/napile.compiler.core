 ...
 * @author abreslav
 */
public class NapileAnonymousClass extends NapileNamedDeclarationStub<PsiJetObjectStub> implements NapileLikeClass
{
	public NapileAnonymousClass(@NotNull ASTNode node)
	{
		super(node);
	}

	public NapileAnonymousClass(@NotNull PsiJetObjectStub stub)
	{
	...
	{
		return findChildByType(JetTokens.ANONYMOUS_KEYWORD);
	}
