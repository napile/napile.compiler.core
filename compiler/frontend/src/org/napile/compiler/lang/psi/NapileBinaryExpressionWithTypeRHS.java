 ...
 * @author max
 */
public class NapileBinaryExpressionWithTypeRHS extends NapileExpressionImpl
{
	public NapileBinaryExpressionWithTypeRHS(@NotNull ASTNode node)
	{
		super(node);
	}
	...
	@Nullable
	@IfNotParsed
	public NapileTypeReference getRight()
	{
		ASTNode node = getOperationSign().getNode();
		while(node != null)
		{
			PsiElement psi = node.getPsi();
			if(psi instanceof NapileTypeReference)
			{
				return (NapileTypeReference) psi;
			}
