 ...
 * @date 23:46/05.09.12
 */
public class NapilePsiRetellEntryStubImpl extends StubBase<NapileRetellEntry> implements NapilePsiRetellEntryStub
{
	private final StringRef stringRef;

	public NapilePsiRetellEntryStubImpl(StubElement parent, StringRef stringRef)
	{
		super(parent, JetStubElementTypes.RETELL_ENTRY);
