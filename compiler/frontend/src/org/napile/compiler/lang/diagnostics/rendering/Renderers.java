...
public class Renderers
{
	...
	public static final Renderer<NapileClassOrObject> RENDER_CLASS_OR_OBJECT = new Renderer<NapileClassOrObject>()
	{
		@NotNull
		@Override
		public String render(@NotNull NapileClassOrObject classOrObject)
		{
