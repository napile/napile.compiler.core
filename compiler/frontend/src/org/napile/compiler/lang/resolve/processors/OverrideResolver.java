...
public class OverrideResolver
{
	...
	private void generateOverridesInAClass(@NotNull final MutableClassDescriptor classDescriptor, @NotNull Set<ClassifierDescriptor> processed, @NotNull Set<MutableClassDescriptor> ourClasses)
	{
	...
	public static void generateOverridesInFunctionGroup(@NotNull Name name, //DO NOT DELETE THIS PARAMETER: needed to make sure all descriptors have the same name
			@NotNull Collection<? extends CallableMemberDescriptor> membersFromSupertypes, @NotNull Collection<? extends CallableMemberDescriptor> membersFromCurrent, @NotNull ClassDescriptor current, @NotNull DescriptorSink sink)
	{
	...
	private static void extractAndBindOverridesForMember(@NotNull CallableMemberDescriptor fromCurrent, @NotNull List<CallableMemberDescriptor> notOverridden, @NotNull ClassDescriptor current, @NotNull DescriptorSink sink)
	{
	...
	private static void bindFakeOverrides(@NotNull ClassDescriptor current, @NotNull List<CallableMemberDescriptor> notOverridden, @NotNull DescriptorSink sink)
	{
	...
	private static void bindFakeOverride(@NotNull CallableMemberDescriptor notOverriddenFromSuper, @NotNull Collection<CallableMemberDescriptor> overridables, @NotNull ClassDescriptor current, @NotNull DescriptorSink sink)
	{
		...
		CallableMemberDescriptor fakeOverride = notOverriddenFromSuper.copy(current, modality, allInvisible, CallableMemberDescriptor.Kind.FAKE_OVERRIDE, false);
	...
	@NotNull
	private static Collection<CallableMemberDescriptor> filterVisible(@NotNull final ClassDescriptor current, @NotNull Collection<CallableMemberDescriptor> toFilter)
	{
	...
	@NotNull
	private static Collection<CallableMemberDescriptor> extractMembersOverridableBy(@NotNull CallableMemberDescriptor overrider, @NotNull Queue<CallableMemberDescriptor> extractFrom, @NotNull DescriptorSink sink)
	{
	...
	public static Multimap<CallableMemberDescriptor, CallableMemberDescriptor> collectSuperMethods(MutableClassDescriptor classDescriptor)
	{
		...
		for(CallableMemberDescriptor one : filteredMembers)
		{
			...
			for(CallableMemberDescriptor another : filteredMembers)
			{
				...
				if(OverridingUtil.isOverridableBy(one, another).getResult() == OverridingUtil.OverrideCompatibilityInfo.Result.OVERRIDABLE || OverridingUtil.isOverridableBy(another, one).getResult() == OverridingUtil.OverrideCompatibilityInfo.Result.OVERRIDABLE)
				{
	...
	private void checkVisibilityForMember(@NotNull NapileDeclaration declaration, @NotNull CallableMemberDescriptor memberDescriptor)
	{
