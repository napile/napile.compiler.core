...
{
	private final NapileReferenceExpression reference;
	...
	public ResolutionTaskHolder(@NotNull NapileReferenceExpression reference, @NotNull BasicResolutionContext basicResolutionContext, @NotNull Predicate<ResolutionCandidate<D>> visibleStrategy)
	{
		this.reference = reference;
		this.basicResolutionContext = basicResolutionContext;
		this.visibleStrategy = visibleStrategy;
		this.isSafeCall = NapilePsiUtil.isSafeCall(basicResolutionContext.call);
	}
