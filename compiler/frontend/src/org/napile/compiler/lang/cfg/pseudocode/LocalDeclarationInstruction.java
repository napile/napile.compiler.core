...
public class LocalDeclarationInstruction extends InstructionWithNext
{
	...
	public LocalDeclarationInstruction(@NotNull NapileDeclaration element, Pseudocode body)
	{
		super(element);
		this.body = body;
	}
	...
	@NotNull
	@Override
	public NapileDeclaration getElement()
	{
		return (NapileDeclaration) super.getElement();
	}
