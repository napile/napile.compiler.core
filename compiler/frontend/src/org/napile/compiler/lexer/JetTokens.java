...
public interface JetTokens
{
	...
	NapileKeywordToken TYPE_KEYWORD = NapileKeywordToken.keyword("type");
	...
	NapileKeywordToken OBJECT_KEYWORD = NapileKeywordToken.keyword("object");
	...
	NapileToken ATAT = new NapileToken("ATAT");
	...
	NapileKeywordToken WHERE_KEYWORD = NapileKeywordToken.softKeyword("where");
	NapileKeywordToken BY_KEYWORD = NapileKeywordToken.softKeyword("by");
	...
	NapileKeywordToken ENUM_KEYWORD = NapileKeywordToken.softKeyword("enum");
	...
	TokenSet KEYWORDS = TokenSet.create(PACKAGE_KEYWORD, AS_KEYWORD, TYPE_KEYWORD, CLASS_KEYWORD, THIS_KEYWORD, SUPER_KEYWORD, VAL_KEYWORD, VAR_KEYWORD, METH_KEYWORD, FOR_KEYWORD, NULL_KEYWORD, TRUE_KEYWORD, FALSE_KEYWORD, IS_KEYWORD, IN_KEYWORD, THROW_KEYWORD, RETURN_KEYWORD, BREAK_KEYWORD, CONTINUE_KEYWORD, OBJECT_KEYWORD, IF_KEYWORD, ELSE_KEYWORD, WHILE_KEYWORD, DO_KEYWORD, TRY_KEYWORD, WHEN_KEYWORD, NOT_IN, NOT_IS, AS_SAFE);

	TokenSet SOFT_KEYWORDS = TokenSet.create(STATIC_KEYWORD, HERITABLE_KEYWORD, IMPORT_KEYWORD, WHERE_KEYWORD, BY_KEYWORD, GET_KEYWORD, SET_KEYWORD, ABSTRACT_KEYWORD, ENUM_KEYWORD, OVERRIDE_KEYWORD, LOCAL_KEYWORD, COVERED_KEYWORD, CATCH_KEYWORD, FINALLY_KEYWORD, OUT_KEYWORD, FINAL_KEYWORD, VARARG_KEYWORD, REIFIED_KEYWORD);

	TokenSet MODIFIER_KEYWORDS = TokenSet.create(ABSTRACT_KEYWORD, ENUM_KEYWORD, OVERRIDE_KEYWORD, LOCAL_KEYWORD, COVERED_KEYWORD, OUT_KEYWORD, IN_KEYWORD, FINAL_KEYWORD, VARARG_KEYWORD, REIFIED_KEYWORD, HERITABLE_KEYWORD, STATIC_KEYWORD);
