...
public interface JetTokens
{
	...
	TokenSet SOFT_KEYWORDS = TokenSet.create(STATIC_KEYWORD, HERITABLE_KEYWORD, IMPORT_KEYWORD, WHERE_KEYWORD, GET_KEYWORD, SET_KEYWORD, ABSTRACT_KEYWORD, OVERRIDE_KEYWORD, LOCAL_KEYWORD, COVERED_KEYWORD, CATCH_KEYWORD, FINALLY_KEYWORD, FINAL_KEYWORD, VARARG_KEYWORD, REIFIED_KEYWORD);
