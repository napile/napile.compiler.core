...
public interface JetTokens
{
	...
	JetKeywordToken METH_KEYWORD = JetKeywordToken.keyword("meth");
	...
	JetKeywordToken STATIC_KEYWORD = JetKeywordToken.softKeyword("static");
	...
	TokenSet SOFT_KEYWORDS = TokenSet.create(STATIC_KEYWORD, HERITABLE_KEYWORD, IMPORT_KEYWORD, WHERE_KEYWORD, BY_KEYWORD, GET_KEYWORD, SET_KEYWORD, ABSTRACT_KEYWORD, ENUM_KEYWORD, OVERRIDE_KEYWORD, LOCAL_KEYWORD, COVERED_KEYWORD, CATCH_KEYWORD, FINALLY_KEYWORD, OUT_KEYWORD, FINAL_KEYWORD, VARARG_KEYWORD, INLINE_KEYWORD, REIFIED_KEYWORD);

	TokenSet MODIFIER_KEYWORDS = TokenSet.create(ABSTRACT_KEYWORD, ENUM_KEYWORD, OVERRIDE_KEYWORD, LOCAL_KEYWORD, COVERED_KEYWORD, OUT_KEYWORD, IN_KEYWORD, FINAL_KEYWORD, VARARG_KEYWORD, INLINE_KEYWORD, REIFIED_KEYWORD, HERITABLE_KEYWORD, STATIC_KEYWORD);
