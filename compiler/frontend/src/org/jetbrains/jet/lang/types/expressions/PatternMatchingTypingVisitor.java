...
import static org.jetbrains.jet.lang.diagnostics.Errors.EXPECTED_CONDITION;
import static org.jetbrains.jet.lang.diagnostics.Errors.INCOMPATIBLE_TYPES;
import static org.jetbrains.jet.lang.diagnostics.Errors.SENSELESS_NULL_IN_WHEN;
import static org.jetbrains.jet.lang.diagnostics.Errors.TYPE_MISMATCH_IN_BINDING_PATTERN;
import static org.jetbrains.jet.lang.diagnostics.Errors.TYPE_MISMATCH_IN_CONDITION;
import static org.jetbrains.jet.lang.diagnostics.Errors.TYPE_MISMATCH_IN_RANGE;
import static org.jetbrains.jet.lang.diagnostics.Errors.TYPE_MISMATCH_IN_TUPLE_PATTERN;
...
public class PatternMatchingTypingVisitor extends ExpressionTypingVisitor
{
	...
	private Pair<DataFlowInfo, DataFlowInfo> checkPatternType(@NotNull JetPattern pattern, @NotNull final JetType subjectType, final boolean conditionExpected, @NotNull final WritableScope scopeToExtend, final ExpressionTypingContext context, @NotNull final DataFlowValue... subjectVariables)
	{
