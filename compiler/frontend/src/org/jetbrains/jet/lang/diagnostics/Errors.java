...
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.ABSTRACT_MODIFIER;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.ARRAY_ACCESS;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.CALL_ELEMENT;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.CALL_EXPRESSION;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.DECLARATION;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.DECLARATION_RETURN_TYPE;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.DECLARATION_WITH_BODY;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.ELSE_ENTRY;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.NAMED_ELEMENT;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.NAME_IDENTIFIER;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.NULLABLE_TYPE;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.OVERRIDE_MODIFIER;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.PARAMETER_DEFAULT_VALUE;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.PROJECTION_MODIFIER;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.VISIBILITY_MODIFIER;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.WHEN_CONDITION_IN_RANGE;
import static org.jetbrains.jet.lang.diagnostics.PositioningStrategies.WHEN_EXPRESSION;
...
public interface Errors
{
	...
	SimpleDiagnosticFactory<JetTypeProjection> PROJECTION_IN_IMMEDIATE_ARGUMENT_TO_SUPERTYPE = SimpleDiagnosticFactory.create(ERROR, PROJECTION_MODIFIER);
	...
	SimpleDiagnosticFactory<PsiElement> PACKAGE_MEMBER_CANNOT_BE_HERITABLE = SimpleDiagnosticFactory.create(ERROR);
	...
	DiagnosticFactory2<NapileMethod, String, ClassDescriptor> ABSTRACT_FUNCTION_IN_NON_ABSTRACT_CLASS = DiagnosticFactory2.create(ERROR, ABSTRACT_MODIFIER);
	DiagnosticFactory1<NapileMethod, SimpleFunctionDescriptor> ABSTRACT_FUNCTION_WITH_BODY = DiagnosticFactory1.create(ERROR, ABSTRACT_MODIFIER);
	DiagnosticFactory1<NapileMethod, SimpleFunctionDescriptor> NON_ABSTRACT_FUNCTION_WITH_NO_BODY = DiagnosticFactory1.create(ERROR, NAMED_ELEMENT);
	...
	DiagnosticFactory1<NapileMethod, SimpleFunctionDescriptor> NON_MEMBER_FUNCTION_NO_BODY = DiagnosticFactory1.create(ERROR, NAMED_ELEMENT);
	...
	DiagnosticFactory3<PsiNameIdentifierOwner, CallableMemberDescriptor, CallableMemberDescriptor, DeclarationDescriptor> VIRTUAL_MEMBER_HIDDEN = DiagnosticFactory3.create(ERROR, NAMED_ELEMENT);
	DiagnosticFactory3<JetModifierListOwner, CallableMemberDescriptor, CallableDescriptor, DeclarationDescriptor> CANNOT_OVERRIDE_INVISIBLE_MEMBER = DiagnosticFactory3.create(ERROR, OVERRIDE_MODIFIER);
	...
	DiagnosticFactory2<JetSimpleNameExpression, DeclarationDescriptor, JetSimpleNameExpression> ASSIGNMENT_OPERATOR_SHOULD_RETURN_UNIT = DiagnosticFactory2.create(ERROR);
	...
	DiagnosticFactory3<JetDelegationSpecifierList, TypeParameterDescriptor, ClassDescriptor, Collection<JetType>> INCONSISTENT_TYPE_PARAMETER_VALUES = DiagnosticFactory3.create(ERROR);
	...
	DiagnosticFactory3<JetModifierListOwner, Visibility, CallableMemberDescriptor, DeclarationDescriptor> CANNOT_WEAKEN_ACCESS_PRIVILEGE = DiagnosticFactory3.create(ERROR, VISIBILITY_MODIFIER);
	DiagnosticFactory3<JetModifierListOwner, Visibility, CallableMemberDescriptor, DeclarationDescriptor> CANNOT_CHANGE_ACCESS_PRIVILEGE = DiagnosticFactory3.create(ERROR, VISIBILITY_MODIFIER);

	DiagnosticFactory2<JetNamedDeclaration, CallableMemberDescriptor, CallableMemberDescriptor> RETURN_TYPE_MISMATCH_ON_OVERRIDE = DiagnosticFactory2.create(ERROR, DECLARATION_RETURN_TYPE);
	...
	DiagnosticFactory1<JetClassOrObject, ValueParameterDescriptor> MULTIPLE_DEFAULTS_INHERITED_FROM_SUPERTYPES_WHEN_NO_EXPLICIT_OVERRIDE = DiagnosticFactory1.create(ERROR, NAME_IDENTIFIER);
	DiagnosticFactory2<JetParameter, ClassDescriptor, ValueParameterDescriptor> PARAMETER_NAME_CHANGED_ON_OVERRIDE = DiagnosticFactory2.create(WARNING, NAME_IDENTIFIER);
	DiagnosticFactory2<JetClassOrObject, Collection<? extends CallableMemberDescriptor>, Integer> DIFFERENT_NAMES_FOR_THE_SAME_PARAMETER_IN_SUPERTYPES = DiagnosticFactory2.create(WARNING, NAME_IDENTIFIER);
