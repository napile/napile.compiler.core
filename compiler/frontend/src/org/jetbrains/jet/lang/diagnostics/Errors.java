...
public interface Errors
{
	...
	DiagnosticFactory1<PsiElement, JetType> MISSED_SUPER_CALL = DiagnosticFactory1.create(ERROR);
	SimpleDiagnosticFactory<JetTypeReference> INVALID_SUPER_CALL = SimpleDiagnosticFactory.create(ERROR);
