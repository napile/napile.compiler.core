...
import static org.jetbrains.jet.lang.cfg.PseudocodeVariablesData.VariableUseState.LAST_READ;
import static org.jetbrains.jet.lang.cfg.PseudocodeVariablesData.VariableUseState.LAST_WRITTEN;
import static org.jetbrains.jet.lang.cfg.PseudocodeVariablesData.VariableUseState.ONLY_WRITTEN_NEVER_READ;
import static org.jetbrains.jet.lang.diagnostics.Errors.NO_BACKING_FIELD_ABSTRACT_PROPERTY;
import static org.jetbrains.jet.lang.diagnostics.Errors.NO_BACKING_FIELD_CUSTOM_ACCESSORS;
import static org.jetbrains.jet.lang.diagnostics.Errors.NO_RETURN_IN_FUNCTION_WITH_BLOCK_BODY;
import static org.jetbrains.jet.lang.diagnostics.Errors.RETURN_IN_FUNCTION_WITH_EXPRESSION_BODY;
import static org.jetbrains.jet.lang.diagnostics.Errors.RETURN_TYPE_MISMATCH;
import static org.jetbrains.jet.lang.diagnostics.Errors.UNREACHABLE_CODE;
...
public class JetFlowInformationProvider
{
	...
	public void checkDefiniteReturn(final @NotNull JetType expectedReturnType)
	{
		...
		if(expectedReturnType != NO_EXPECTED_TYPE &&
	...
	public void markUninitializedVariables(final boolean processLocalDeclaration)
	{
		...
		{
			@Override
			public void execute(@NotNull Instruction instruction, @Nullable Map<VariableDescriptor, VariableInitState> in, @Nullable Map<VariableDescriptor, PseudocodeVariablesData.VariableInitState> out)
			{
	...
	private boolean checkValReassignment(@NotNull VariableDescriptor variableDescriptor, @NotNull JetExpression expression, @NotNull VariableInitState enterInitState, @NotNull Collection<VariableDescriptor> varWithValReassignErrorGenerated)
	{
	...
	private boolean checkBackingField(@NotNull VariableDescriptor variableDescriptor, @NotNull JetElement element)
	{
		...
		if(isBackingFieldReference((JetElement) element.getParent(), error, false))
		{
	...
	public void markUnusedVariables()
	{
		...
		InstructionDataAnalyzeStrategy<Map<VariableDescriptor, VariableUseState>> variableStatusAnalyzeStrategy = new InstructionDataAnalyzeStrategy<Map<VariableDescriptor, PseudocodeVariablesData.VariableUseState>>()
		{
			@Override
			public void execute(@NotNull Instruction instruction, @Nullable Map<VariableDescriptor, PseudocodeVariablesData.VariableUseState> in, @Nullable Map<VariableDescriptor, VariableUseState> out)
			{
				...
				{
					if(trace.get(CAPTURED_IN_CLOSURE, variableDescriptor))
						return;
