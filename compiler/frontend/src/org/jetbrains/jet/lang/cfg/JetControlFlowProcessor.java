...
import static org.jetbrains.jet.lang.diagnostics.Errors.BREAK_OR_CONTINUE_OUTSIDE_A_LOOP;
import static org.jetbrains.jet.lang.diagnostics.Errors.ELSE_MISPLACED_IN_WHEN;
import static org.jetbrains.jet.lang.diagnostics.Errors.NOT_A_LOOP_LABEL;
import static org.jetbrains.jet.lang.diagnostics.Errors.NO_ELSE_IN_WHEN;
...
public class JetControlFlowProcessor
{
	...
	private class CFPVisitor extends JetVisitorVoid
	{
		...
		public void visitReturnExpression(JetReturnExpression expression)
		{
			...
			if(subroutine instanceof NapileMethod || subroutine instanceof JetPropertyAccessor)
			{
				if(returnedExpression == null)
				{
