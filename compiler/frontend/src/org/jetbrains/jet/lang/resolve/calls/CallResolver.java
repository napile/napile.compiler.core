...
import static org.jetbrains.jet.lang.diagnostics.Errors.CALLEE_NOT_A_FUNCTION;
...
import static org.jetbrains.jet.lang.resolve.BindingContext.RESOLUTION_RESULTS_FOR_FUNCTION;
import static org.jetbrains.jet.lang.resolve.BindingContext.RESOLUTION_RESULTS_FOR_PROPERTY;
import static org.jetbrains.jet.lang.resolve.BindingContext.RESOLUTION_SCOPE;
import static org.jetbrains.jet.lang.resolve.BindingContext.TRACE_DELTAS_CACHE;
import static org.jetbrains.jet.lang.resolve.calls.ResolutionStatus.OTHER_ERROR;
import static org.jetbrains.jet.lang.resolve.calls.ResolutionStatus.SEVERITY_LEVELS;
import static org.jetbrains.jet.lang.resolve.calls.ResolutionStatus.STRONG_ERROR;
import static org.jetbrains.jet.lang.resolve.calls.ResolutionStatus.SUCCESS;
import static org.jetbrains.jet.lang.resolve.calls.ResolutionStatus.TYPE_INFERENCE_ERROR;
import static org.jetbrains.jet.lang.resolve.calls.ResolutionStatus.UNKNOWN_STATUS;
import static org.jetbrains.jet.lang.resolve.calls.ResolutionStatus.UNSAFE_CALL_ERROR;
...
public class CallResolver
{
	...
	@NotNull
	public OverloadResolutionResults<FunctionDescriptor> resolveCallWithGivenName(@NotNull BasicResolutionContext context, @NotNull final JetReferenceExpression functionReference, @NotNull Name name)
	{
		...
		else
		{
			...
			else if(calleeExpression != null)
			{
				...
				FunctionDescriptorImpl functionDescriptor = new ExpressionAsFunctionDescriptor(context.scope.getContainingDeclaration(), Name.special("<for expression " +
						...
						">"));
				FunctionDescriptorUtil.initializeFromFunctionType(functionDescriptor, calleeType, NO_RECEIVER, Modality.FINAL, Visibilities.LOCAL2);
	...
	private <D extends CallableDescriptor, F extends D> OverloadResolutionResults<F> doResolveCall(@NotNull final BasicResolutionContext context, @NotNull final List<ResolutionTask<D, F>> prioritizedTasks, // high to low priority
			@NotNull CallTransformer<D, F> callTransformer, @NotNull final JetReferenceExpression reference)
	{
