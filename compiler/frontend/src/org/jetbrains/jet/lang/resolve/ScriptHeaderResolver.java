...
public class ScriptHeaderResolver
{
	...
	public void resolveScriptDeclarations()
	{
		for(Map.Entry<JetScript, ScriptDescriptor> e : context.getScripts().entrySet())
		{
			...
			int index = 0;
			List<AnalyzerScriptParameter> scriptParameters = !scriptDefinition.getScriptParameters().isEmpty() ? scriptDefinition.getScriptParameters() : topDownAnalysisParameters.getScriptParameters();
