...
public class FileBasedPackageMemberDeclarationProvider extends AbstractPsiBasedDeclarationProvider implements PackageMemberDeclarationProvider
{
	...
	/*package*/ FileBasedPackageMemberDeclarationProvider(@NotNull FqName fqName, @NotNull FileBasedDeclarationProviderFactory factory, @NotNull Collection<JetFile> allFiles)
	{
		this.fqName = fqName;
