...
public class JetParsing extends AbstractJetParsing
{
	...
	private static final TokenSet TOPLEVEL_OBJECT_FIRST = TokenSet.create(CLASS_KEYWORD);
	private static final TokenSet ENUM_MEMBER_FIRST = TokenSet.create(TYPE_KEYWORD, CLASS_KEYWORD, METH_KEYWORD, VAL_KEYWORD, IDENTIFIER);
	...
	IElementType parseProperty(boolean local)
	{
		...
		TokenSet propertyNameFollow = TokenSet.create(COLON, EQ, LBRACE, RBRACE, SEMICOLON, VAL_KEYWORD, VAR_KEYWORD, METH_KEYWORD, CLASS_KEYWORD);
