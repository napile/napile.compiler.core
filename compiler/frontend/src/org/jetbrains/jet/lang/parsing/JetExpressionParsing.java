...
import static org.jetbrains.jet.JetNodeTypes.ANNOTATED_EXPRESSION;
import static org.jetbrains.jet.JetNodeTypes.ARRAY_ACCESS_EXPRESSION;
import static org.jetbrains.jet.JetNodeTypes.BINARY_EXPRESSION;
import static org.jetbrains.jet.JetNodeTypes.BINARY_WITH_PATTERN;
import static org.jetbrains.jet.JetNodeTypes.BINARY_WITH_TYPE;
import static org.jetbrains.jet.JetNodeTypes.BINDING_PATTERN;
import static org.jetbrains.jet.JetNodeTypes.BLOCK;
import static org.jetbrains.jet.JetNodeTypes.BODY;
import static org.jetbrains.jet.JetNodeTypes.BOOLEAN_CONSTANT;
import static org.jetbrains.jet.JetNodeTypes.BREAK;
import static org.jetbrains.jet.JetNodeTypes.CALL_EXPRESSION;
import static org.jetbrains.jet.JetNodeTypes.CATCH;
import static org.jetbrains.jet.JetNodeTypes.CHARACTER_CONSTANT;
import static org.jetbrains.jet.JetNodeTypes.CONDITION;
import static org.jetbrains.jet.JetNodeTypes.CONTINUE;
import static org.jetbrains.jet.JetNodeTypes.DECOMPOSER_ARGUMENT;
import static org.jetbrains.jet.JetNodeTypes.DECOMPOSER_ARGUMENT_LIST;
import static org.jetbrains.jet.JetNodeTypes.DECOMPOSER_PATTERN;
import static org.jetbrains.jet.JetNodeTypes.DOT_QUALIFIED_EXPRESSION;
import static org.jetbrains.jet.JetNodeTypes.DO_WHILE;
import static org.jetbrains.jet.JetNodeTypes.ELSE;
import static org.jetbrains.jet.JetNodeTypes.ESCAPE_STRING_TEMPLATE_ENTRY;
import static org.jetbrains.jet.JetNodeTypes.EXPRESSION_PATTERN;
import static org.jetbrains.jet.JetNodeTypes.FINALLY;
import static org.jetbrains.jet.JetNodeTypes.FLOAT_CONSTANT;
import static org.jetbrains.jet.JetNodeTypes.FOR;
import static org.jetbrains.jet.JetNodeTypes.FUNCTION_LITERAL;
import static org.jetbrains.jet.JetNodeTypes.FUNCTION_LITERAL_EXPRESSION;
import static org.jetbrains.jet.JetNodeTypes.IF;
import static org.jetbrains.jet.JetNodeTypes.INDICES;
import static org.jetbrains.jet.JetNodeTypes.INTEGER_CONSTANT;
import static org.jetbrains.jet.JetNodeTypes.LABELED_TUPLE_ENTRY;
import static org.jetbrains.jet.JetNodeTypes.LABEL_QUALIFIER;
import static org.jetbrains.jet.JetNodeTypes.LABEL_REFERENCE;
import static org.jetbrains.jet.JetNodeTypes.LITERAL_STRING_TEMPLATE_ENTRY;
import static org.jetbrains.jet.JetNodeTypes.LONG_STRING_TEMPLATE_ENTRY;
import static org.jetbrains.jet.JetNodeTypes.LOOP_PARAMETER;
import static org.jetbrains.jet.JetNodeTypes.LOOP_RANGE;
import static org.jetbrains.jet.JetNodeTypes.MODIFIER_LIST;
import static org.jetbrains.jet.JetNodeTypes.NULL;
import static org.jetbrains.jet.JetNodeTypes.OBJECT_DECLARATION;
import static org.jetbrains.jet.JetNodeTypes.OBJECT_LITERAL;
import static org.jetbrains.jet.JetNodeTypes.OPERATION_REFERENCE;
import static org.jetbrains.jet.JetNodeTypes.PARENTHESIZED;
import static org.jetbrains.jet.JetNodeTypes.POSTFIX_EXPRESSION;
import static org.jetbrains.jet.JetNodeTypes.PREFIX_EXPRESSION;
import static org.jetbrains.jet.JetNodeTypes.PROPERTY;
import static org.jetbrains.jet.JetNodeTypes.REFERENCE_EXPRESSION;
import static org.jetbrains.jet.JetNodeTypes.RETURN;
import static org.jetbrains.jet.JetNodeTypes.ROOT_NAMESPACE;
import static org.jetbrains.jet.JetNodeTypes.SAFE_ACCESS_EXPRESSION;
import static org.jetbrains.jet.JetNodeTypes.SHORT_STRING_TEMPLATE_ENTRY;
import static org.jetbrains.jet.JetNodeTypes.STRING_TEMPLATE;
import static org.jetbrains.jet.JetNodeTypes.SUPER_EXPRESSION;
import static org.jetbrains.jet.JetNodeTypes.THEN;
import static org.jetbrains.jet.JetNodeTypes.THIS_EXPRESSION;
import static org.jetbrains.jet.JetNodeTypes.THROW;
import static org.jetbrains.jet.JetNodeTypes.TRY;
import static org.jetbrains.jet.JetNodeTypes.TUPLE;
import static org.jetbrains.jet.JetNodeTypes.TUPLE_PATTERN;
import static org.jetbrains.jet.JetNodeTypes.TUPLE_PATTERN_ENTRY;
import static org.jetbrains.jet.JetNodeTypes.TYPE_ARGUMENT_LIST;
import static org.jetbrains.jet.JetNodeTypes.TYPE_PATTERN;
...
import static org.jetbrains.jet.JetNodeTypes.VALUE_ARGUMENT_NAME;
import static org.jetbrains.jet.JetNodeTypes.VALUE_PARAMETER;
import static org.jetbrains.jet.JetNodeTypes.VALUE_PARAMETER_LIST;
import static org.jetbrains.jet.JetNodeTypes.WHEN;
import static org.jetbrains.jet.JetNodeTypes.WHEN_CONDITION_EXPRESSION;
import static org.jetbrains.jet.JetNodeTypes.WHEN_CONDITION_IN_RANGE;
import static org.jetbrains.jet.JetNodeTypes.WHEN_CONDITION_IS_PATTERN;
import static org.jetbrains.jet.JetNodeTypes.WHEN_ENTRY;
import static org.jetbrains.jet.JetNodeTypes.WHILE;
import static org.jetbrains.jet.JetNodeTypes.WILDCARD_PATTERN;
import static org.jetbrains.jet.lexer.JetTokens.ANDAND;
import static org.jetbrains.jet.lexer.JetTokens.ARROW;
import static org.jetbrains.jet.lexer.JetTokens.AS_KEYWORD;
import static org.jetbrains.jet.lexer.JetTokens.AS_SAFE;
import static org.jetbrains.jet.lexer.JetTokens.AT;
import static org.jetbrains.jet.lexer.JetTokens.ATAT;
...
import static org.jetbrains.jet.lexer.JetTokens.CHARACTER_LITERAL;
import static org.jetbrains.jet.lexer.JetTokens.CLASS_KEYWORD;
import static org.jetbrains.jet.lexer.JetTokens.CLOSING_QUOTE;
...
import static org.jetbrains.jet.lexer.JetTokens.DANGLING_NEWLINE;
import static org.jetbrains.jet.lexer.JetTokens.DIV;
import static org.jetbrains.jet.lexer.JetTokens.DIVEQ;
import static org.jetbrains.jet.lexer.JetTokens.DOT;
import static org.jetbrains.jet.lexer.JetTokens.DO_KEYWORD;
import static org.jetbrains.jet.lexer.JetTokens.ELSE_KEYWORD;
import static org.jetbrains.jet.lexer.JetTokens.ELVIS;
import static org.jetbrains.jet.lexer.JetTokens.ENUM_KEYWORD;
import static org.jetbrains.jet.lexer.JetTokens.EOL_OR_SEMICOLON;
...
import static org.jetbrains.jet.lexer.JetTokens.ESCAPE_SEQUENCE;
...
import static org.jetbrains.jet.lexer.JetTokens.FIELD_IDENTIFIER;
import static org.jetbrains.jet.lexer.JetTokens.FINALLY_KEYWORD;
import static org.jetbrains.jet.lexer.JetTokens.FLOAT_LITERAL;
import static org.jetbrains.jet.lexer.JetTokens.FOR_KEYWORD;
import static org.jetbrains.jet.lexer.JetTokens.METH_KEYWORD;
import static org.jetbrains.jet.lexer.JetTokens.GT;
import static org.jetbrains.jet.lexer.JetTokens.GTEQ;
import static org.jetbrains.jet.lexer.JetTokens.HASH;
import static org.jetbrains.jet.lexer.JetTokens.IDENTIFIER;
import static org.jetbrains.jet.lexer.JetTokens.IDE_TEMPLATE_END;
import static org.jetbrains.jet.lexer.JetTokens.IDE_TEMPLATE_START;
import static org.jetbrains.jet.lexer.JetTokens.IF_KEYWORD;
import static org.jetbrains.jet.lexer.JetTokens.INTEGER_LITERAL;
import static org.jetbrains.jet.lexer.JetTokens.IN_KEYWORD;
import static org.jetbrains.jet.lexer.JetTokens.IS_KEYWORD;
import static org.jetbrains.jet.lexer.JetTokens.KEYWORDS;
import static org.jetbrains.jet.lexer.JetTokens.LABELS;
import static org.jetbrains.jet.lexer.JetTokens.LABEL_IDENTIFIER;
import static org.jetbrains.jet.lexer.JetTokens.LBRACE;
import static org.jetbrains.jet.lexer.JetTokens.LBRACKET;
import static org.jetbrains.jet.lexer.JetTokens.LONG_TEMPLATE_ENTRY_END;
import static org.jetbrains.jet.lexer.JetTokens.LONG_TEMPLATE_ENTRY_START;
import static org.jetbrains.jet.lexer.JetTokens.LPAR;
...
import static org.jetbrains.jet.lexer.JetTokens.MODIFIER_KEYWORDS;
import static org.jetbrains.jet.lexer.JetTokens.MUL;
import static org.jetbrains.jet.lexer.JetTokens.MULTEQ;
import static org.jetbrains.jet.lexer.JetTokens.NOT_IN;
import static org.jetbrains.jet.lexer.JetTokens.NOT_IS;
...
import static org.jetbrains.jet.lexer.JetTokens.OPEN_QUOTE;
import static org.jetbrains.jet.lexer.JetTokens.OPERATIONS;
...
import static org.jetbrains.jet.lexer.JetTokens.RBRACKET;
import static org.jetbrains.jet.lexer.JetTokens.REGULAR_STRING_PART;
import static org.jetbrains.jet.lexer.JetTokens.RETURN_KEYWORD;
import static org.jetbrains.jet.lexer.JetTokens.RPAR;
import static org.jetbrains.jet.lexer.JetTokens.SAFE_ACCESS;
import static org.jetbrains.jet.lexer.JetTokens.SEMICOLON;
import static org.jetbrains.jet.lexer.JetTokens.SHORT_TEMPLATE_ENTRY_START;
...
import static org.jetbrains.jet.lexer.JetTokens.WHEN_KEYWORD;
import static org.jetbrains.jet.lexer.JetTokens.WHILE_KEYWORD;
...
public class JetExpressionParsing extends AbstractJetParsing
{
	...
	private static final TokenSet TYPE_ARGUMENT_LIST_STOPPERS = TokenSet.create(INTEGER_LITERAL, FLOAT_LITERAL, CHARACTER_LITERAL, OPEN_QUOTE, PACKAGE_KEYWORD, AS_KEYWORD, TYPE_KEYWORD, CLASS_KEYWORD, THIS_KEYWORD, VAL_KEYWORD, VAR_KEYWORD, METH_KEYWORD, FOR_KEYWORD, NULL_KEYWORD, TRUE_KEYWORD, FALSE_KEYWORD, IS_KEYWORD, THROW_KEYWORD, RETURN_KEYWORD, BREAK_KEYWORD, CONTINUE_KEYWORD, OBJECT_KEYWORD, IF_KEYWORD, TRY_KEYWORD, ELSE_KEYWORD, WHILE_KEYWORD, DO_KEYWORD, WHEN_KEYWORD, RBRACKET, RBRACE, RPAR, PLUSPLUS, MINUSMINUS, EXCLEXCL,
			//            MUL,
			PLUS, MINUS, EXCL, DIV, PERC, LTEQ,
			// TODO GTEQ,   foo<bar, baz>=x
			EQEQEQ, EXCLEQEQEQ, EQEQ, EXCLEQ, ANDAND, OROR, SAFE_ACCESS, ELVIS, SEMICOLON, RANGE, EQ, MULTEQ, DIVEQ, PERCEQ, PLUSEQ, MINUSEQ, NOT_IN, NOT_IS, //HASH,
			COLON);

	/*package*/ static final TokenSet EXPRESSION_FIRST = TokenSet.create(
			// Prefix
			MINUS, PLUS, MINUSMINUS, PLUSPLUS, EXCL, EXCLEXCL, // Joining complex tokens makes it necessary to put EXCLEXCL here
			...
			// literal constant
			TRUE_KEYWORD, FALSE_KEYWORD, OPEN_QUOTE, INTEGER_LITERAL, CHARACTER_LITERAL, FLOAT_LITERAL, NULL_KEYWORD,
			...
			// jump
			THROW_KEYWORD, RETURN_KEYWORD, CONTINUE_KEYWORD, BREAK_KEYWORD,
	...
	private static final TokenSet STATEMENT_FIRST = TokenSet.orSet(EXPRESSION_FIRST, TokenSet.create(
			// declaration
			LBRACKET, // attribute
			METH_KEYWORD, VAL_KEYWORD, VAR_KEYWORD, CLASS_KEYWORD, TYPE_KEYWORD), MODIFIER_KEYWORDS);

	/*package*/ static final TokenSet EXPRESSION_FOLLOW = TokenSet.create(SEMICOLON, ARROW, COMMA, RBRACE, RPAR, RBRACKET, IDE_TEMPLATE_END);
	...
	private enum Precedence
	{
		...
		PREFIX(MINUS, PLUS, MINUSMINUS, PLUSPLUS, EXCL, LABEL_IDENTIFIER, AT, ATAT)
				{ // attributes
	...
	private void parseAtomicExpression()
	{
		...
		else if(atSet(CLASS_KEYWORD, METH_KEYWORD, VAL_KEYWORD, VAR_KEYWORD, TYPE_KEYWORD))
		{
	...
	private void parsePattern()
	{
		...
		if(at(PACKAGE_KEYWORD) || at(IDENTIFIER) || at(METH_KEYWORD) || at(THIS_KEYWORD))
		{
	...
	private void parseFunctionLiteral(boolean preferBlock)
	{
		...
		else if(at(LPAR))
		{
...

			{
				...
				paramsFound = preferParamsToExpressions ? rollbackOrDrop(rollbackMarker, ARROW, "An -> is expected", RBRACE) : rollbackOrDropAt(rollbackMarker, ARROW);
			}
	...
	private IElementType parseLocalDeclarationRest(boolean isEnum)
	{
		...
		else if(keywordToken == METH_KEYWORD)
		{
