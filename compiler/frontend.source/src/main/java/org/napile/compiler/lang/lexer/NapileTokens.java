...
public interface NapileTokens
{
	...
	NapileKeywordToken REF_KEYWORD = NapileKeywordToken.keyword("ref");
	...
	TokenSet KEYWORDS = TokenSet.create(REF_KEYWORD, PACKAGE_KEYWORD, AS_KEYWORD, CLASS_KEYWORD, THIS_KEYWORD, SUPER_KEYWORD, VAR_KEYWORD, VAL_KEYWORD, METH_KEYWORD, MACRO_KEYWORD, FOR_KEYWORD, NULL_KEYWORD, TRUE_KEYWORD, FALSE_KEYWORD, IS_KEYWORD, IN_KEYWORD, THROW_KEYWORD, RETURN_KEYWORD, BREAK_KEYWORD, CONTINUE_KEYWORD, ANONYM_KEYWORD, IF_KEYWORD, ELSE_KEYWORD, WHILE_KEYWORD, DO_KEYWORD, TRY_KEYWORD, WHEN_KEYWORD, NOT_IN, NOT_IS, AS_SAFE);

	TokenSet SOFT_KEYWORDS = TokenSet.create(ARRAY_OF_KEYWORD, UTIL_KEYWORD, CLASS_OF_KEYWORD, TYPE_OF_KEYWORD, STATIC_KEYWORD, HERITABLE_KEYWORD, IMPORT_KEYWORD, GET_KEYWORD, SET_KEYWORD, LAZY_KEYWORD, ABSTRACT_KEYWORD, OVERRIDE_KEYWORD, LOCAL_KEYWORD, COVERED_KEYWORD, CATCH_KEYWORD, FINALLY_KEYWORD, FINAL_KEYWORD, NATIVE_KEYWORD, LABEL_KEYWORD, ENUM_KEYWORD);

	TokenSet MODIFIER_KEYWORDS = TokenSet.create(ABSTRACT_KEYWORD, UTIL_KEYWORD, OVERRIDE_KEYWORD, LOCAL_KEYWORD, COVERED_KEYWORD, FINAL_KEYWORD, HERITABLE_KEYWORD, STATIC_KEYWORD, NATIVE_KEYWORD, LAZY_KEYWORD, ENUM_KEYWORD);
	TokenSet VARIABLE_LIKE_KEYWORDS = TokenSet.create(VAR_KEYWORD, VAL_KEYWORD, REF_KEYWORD);
