...
public interface NapileTokens
{
	...
	TokenSet MODIFIER_KEYWORDS = TokenSet.create(ABSTRACT_KEYWORD, OVERRIDE_KEYWORD, LOCAL_KEYWORD, COVERED_KEYWORD, FINAL_KEYWORD, VARARG_KEYWORD, REIFIED_KEYWORD, HERITABLE_KEYWORD, STATIC_KEYWORD, NATIVE_KEYWORD, LAZY_KEYWORD);
	TokenSet VARIABLE_AND_VALUE_KEYWORDS = TokenSet.create(VAR_KEYWORD, VAL_KEYWORD);
