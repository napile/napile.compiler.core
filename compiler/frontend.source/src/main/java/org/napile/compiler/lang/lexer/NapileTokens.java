...
public interface NapileTokens
{
	...
	TokenSet SOFT_KEYWORDS = TokenSet.create(ARRAY_OF_KEYWORD, UTIL_KEYWORD, CLASS_OF_KEYWORD, TYPE_OF_KEYWORD, STATIC_KEYWORD, HERITABLE_KEYWORD, IMPORT_KEYWORD, GET_KEYWORD, SET_KEYWORD, LAZY_KEYWORD, ABSTRACT_KEYWORD, OVERRIDE_KEYWORD, LOCAL_KEYWORD, COVERED_KEYWORD, CATCH_KEYWORD, FINALLY_KEYWORD, FINAL_KEYWORD, NATIVE_KEYWORD, LABEL_KEYWORD, ENUM_KEYWORD, REF_KEYWORD);

	TokenSet MODIFIER_KEYWORDS = TokenSet.create(ABSTRACT_KEYWORD, UTIL_KEYWORD, OVERRIDE_KEYWORD, LOCAL_KEYWORD, COVERED_KEYWORD, FINAL_KEYWORD, HERITABLE_KEYWORD, STATIC_KEYWORD, NATIVE_KEYWORD, LAZY_KEYWORD, ENUM_KEYWORD, REF_KEYWORD);
