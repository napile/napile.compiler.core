...
{
	public NapileArrayOfExpressionImpl(@NotNull ASTNode node)
	{
		super(node);
	}
	...
	{
		visitor.visitArrayOfExpression(this);
	}

	@Override
	public <R, D> R accept(@NotNull NapileVisitor<R, D> visitor, D data)
	{
		return visitor.visitArrayOfExpression(this, data);
	}

	@Override
	@NotNull
	public NapileExpression[] getValues()
	{
