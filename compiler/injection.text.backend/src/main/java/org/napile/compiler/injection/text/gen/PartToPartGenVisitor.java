...
{
	private static final MethodRef PLUS_REF = new MethodRef(CodeTodo.STRING_BUILDER.child(Name.identifier("plus")), Arrays.asList(AsmConstants.ANY_TYPE), Collections.<TypeNode>emptyList(),  TypeConstants.STRING_BUILDER);
