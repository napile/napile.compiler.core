...
public class NXmlConstantExpressionImpl extends NXmlParentedElementBase implements NapileConstantExpression
{
	...
	public NXmlConstantExpressionImpl(PsiElement parent)
	{
		super(parent);
	}
	...
	{
		NapileConstantExpression mirror = SourceTreeToPsiMap.treeToPsiNotNull(element);

		setMirrorCheckingType(element, null);

		elementType = mirror.getElementType();
	}
