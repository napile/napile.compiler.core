 ...
 * @date 20:25/16.02.13
 */
public class NXmlCallParameterListImpl extends NXmlStubElementBase<NapilePsiCallParameterListStub> implements NapileCallParameterList
{
	public NXmlCallParameterListImpl(NapilePsiCallParameterListStub stub)
	{
		super(stub);
	}
