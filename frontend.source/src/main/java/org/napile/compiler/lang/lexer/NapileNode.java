...
public class NapileNode extends IElementType
{
	private Constructor<? extends NapileElement> myPsiFactory;

	public NapileNode(@NotNull @NonNls String debugName)
	{
		this(debugName, null);
	}

	public NapileNode(@NotNull @NonNls String debugName, Class<? extends NapileElement> psiClass)
	{
